-- [[ Need to fix hipheight or airwalk ]]
...
local function AddNotification(Title, Text, Icon, Time)
    if Notify then
...
Commands[PrintCommands] = {
    ['Age <player>'] = 'Notifys a players account age';
    ['Airwalk/Air'] = 'Allows you to walk on air';
    ['AntiAFK'] = 'Allows you to be idle for as long as you want';
    ['AntiAim'] = 'Makes it harder for someone who hit you with aimbot';
    ['Antiaimmode Void'] = 'Makes it impossible to die from aimbot';
    ['Antivoid'] = 'Makes it impossible to die in the void';
    ['Antivoiddistance/Voiddistance <number>'] = 'Changes how far your antivoid goes';
    ['Circleradius <number>'] = 'Changes the radius of the circle';
    ['Circlethickness <number>'] = 'Changes the thickness of the circle';
    ['Clearwalls/Inviswalls'] = 'Allows you to see through walls';
    ['Day'] = 'Changes the time to day';
    ['Defaultgravity'] = 'Turns your gravity back to normal';
    ['Dex/Darkdex'] = 'Executes Dex by Moon for Infinite Yield';
    ['Esp <player>'] = 'Traces a player';
    ['Fieldofview/Fov <number>'] = 'Changes your field of view';
    ['Fovcircle/Circle'] = 'Puts a FOVCircle on your screen';
    ['Freeze/Anchor'] = 'Freezes your character';
    ['Gamepassads/Paypopups'] = 'Disables those gamepass pop ups';
    ['Gravity <number>'] = 'Changes your gravity';
    ['Hipheight <number>'] = 'Changes your hipheight (May get you banned)'
    ['Hightlightuser <player>'] = 'Colors a players name on the playerlist';
    ['Infiniteforcefield/Infiniteff'] = 'Turns on infinite forcefield so you cant die';
    ['Infinitejump/Infjump'] = 'Allows you to jump infinitely';
    ['Jump'] = 'Jumps your character once';
    ['']
}
...
local function Keybinds(Array, Restrain)
    if Restrain then
        return nil
    ...
    elseif Array.KeyCode == Enum.KeyCode[Hotkeys.NoclipKey] then
        Noclip = not Noclip
        AddNotification('Lily🗡️', 'Noclip is now '..tostring(Noclip),5)
...
UserInputService.InputBegan:Connect(Keybinds())
UserInputService.InputEnded:Connect(EndKeys())
...
local function Noslow(Args)
    if not User.Character:FindFirstChild'Action' then
        return AddNotification('Lily','Action was not found',5)
...
local function Circle()
    if Drawing then
        ...
        AddNotification('External Error', 'Message from Lily🗡️\nSorry, your executor does not support this API')
    end
end
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'spin') then
        ...
        Spin()
        AddNotification('Lily🗡️', 'Spin is now '..tostring(Spinning),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'view '),1,5) then
        ...
        Viewing = not Viewing
        AddNotification('Lily🗡️', 'Viewing is now '..tostring(Viewing),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'seethroughwalls') then
        ...
        AddNotification('Lily🗡️', 'Clearwalls is now '..tostring(ClearWalls),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'age '),1,4) then
        ...
        if AgeTarget then
            AddNotification('Lily🗡️', AgeTarget.Name.."'s account age is "..AgeTarget.AccountAge)
        end
    end
    LockCommandBar()
end)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'airwalk')
        Airwalk = not Airwalk
        AddNotification('Lily🗡️', 'Airwalk is now '..tostring(Airwalk),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'outerspace') then
        ...
        AddNotification('Lily🗡️', 'Outerspace is now '..tostring(Outerspace))
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'notifications') then
        Notify = not Notify
        AddNotification('Lily🗡️', 'Notificantions are now '..tostring(Notify),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'infiniteforcefield') then
        ...
        AddNotification('Lily🗡️', 'Infinite Forcefield is now'..tostring(InfiniteForcefield),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'circleradius '),1,13) then
        ...
        AddNotification('Lily🗡️', 'Circle radius is now '..tonumber(FovCircleRadius),5)
    elseif string.lower(string.sub(UserCommand.Text == 'circlethickness '),1,16) then
        ...
        AddNotification('Lily🗡️', 'Circle thickness is now '..tonumber(FovCircleThickness),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'spinspeed '),1,10) then
        ...
        AddNotification('Lily🗡️', 'Spinspeed is now '..tonumber(SpinSpeed),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'fieldofview '),1,12) then
        ...
        AddNotification('Lily🗡️', 'Field of view is now '..tonumber(FieldOfView),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'protect '),1,8) then
        ...
        Protect = not Protect
        AddNotification('Lily🗡️', 'Protect is now '..tostring(Protect),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'void') then
        ...
        AddNotification('Lily🗡️', 'Void is now '..tostring(Void))
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'antiaim') then
        AntiAim = not AntiAim
        AddNotification('Lily🗡️', 'Antiaim is now '..tostring(Antiaim),5)
    elseif string.lower(UserCommand.Text == 'antiaimmode void') then
        AntiaimMethod = 'Void'
        if AntiAim then
            if AntiaimMethod == 'Void' then
                AddNotification('Lily🗡️', 'Antiaim mode is now Void',5)
                Void = true
                task.wait()
                repeat task.wait()
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'freeze') then
        Freeze = not Freeze
        AddNotification('Lily🗡️', 'Anchored is now '..tostring(Freeze),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'antiafk') then
        ...
        AddNotification('Lily🗡️', 'Anti-Afk is now true ',5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'paypopups') then
        ...
        PaywallPopups()
        AddNotification('Lily🗡️', 'Gamepass pop ups are now '..tostring(PaidFeaturePopUps),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'zoomdistance '),1,13) then
        ...
        AddNotification('Lily🗡️', 'Zoom distance is now '..tonumber(ZoomDistance),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'antivoiddistance '),1,17)
        ...
        Work.FallenPartsDestroyHeight = -AntivoidDistance
        AddNotification('Lily🗡️', 'Antivoid distance is now '..tonumber(-AntivoidDistance),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'antivoid') then
        ...
        AddNotification('Lily🗡️', 'Antivoid is now '..tostring(AntiVoid),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'maxzoom') then
        ...
        AddNotification('Lily🗡️', 'Max Camera zoom is now true',5)
    elseif string.lower(UserCommand.Text == 'minzoom') then
        User.CameraMaxZoomDistance = 20
        AddNotification('Lily🗡️', 'Min Camera zoom is now true',5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'walkspeed '),1,10)
        ...
        AddNotification('Lily🗡️', 'Walkspeed is now '..tonumber(WalkingSpeed),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'savepos') then
        if User and User.Character and User.Character:FindFirstChild'HumanoidRootPart' then
            ...
            AddNotification('Lily🗡️', 'CFrame saved!',5)
        end
    end
    LockCommandBar()
end)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'loadpos') then
        if not SavedPos then
            AddNotification('Lily🗡️', 'No saved cooridanteframe position was found',5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'time '),1,5) then
        ...
        AddNotification('Lily🗡️', 'Time of day is now '..tonumber(Time),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'resettime')
        Lighting:Destroy()
        AddNotification('Lily🗡️', 'Time of day changed to normal',5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'infjump') then
        ...
        AddNotification('Lily🗡️', 'Infinite Jump is now '..tostring(InfiniteJump),5)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'night') then
        ...
        AddNotification('Lily🗡️', 'Time is now night',5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'day') then
        ...
        AddNotification('Lily🗡️', 'Time is now day',5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'nofog') then
        ...
        AddNotification('Lily🗡️', 'Fog removed',5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'shadows') then
        ...
        AddNotification('Lily🗡️', 'Globalshadows are now '..tostring(Shadows),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'jumppower '),1,10) then
        ...
        AddNotification('Lily🗡️', 'Jump power is now '..tonumber(JumpingPower),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'sprintspeed '),1,12) then
        ...
        AddNotification('Lily🗡️', 'Sprint speed is now '..tonumber(SprintSpeed),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'hipheight '),1,10) then
        ...
        AddNotification('Lily🗡️', ' Hip height is now '..tonumber(HippedHeight),5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'ipgen') then
        if ReplicatedStorage and ReplicatedStorage:FindFirstChild'DefaultChatSystemChatEvents' and ReplicatedStorage:FindFirstChild'DefaultChatSystemChatEvents':FindFirstChild'SayMessageRequest' then
            ...
            AddNotification('Lily🗡️ Detected', 'Lily🗡️ has detected an Internal Error and cannot process chat requests',5)
            task.wait(1)
            AddNotification('Lily🗡️', 'The Ipgen Command has been printed in the Dev Console!, Press F9')
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'highlightuser '),1,14) then
        ...
        AddNotification('Lily🗡️', HighlightedTarget.Name..' has been highlighted in the playerlist',5)
    end
    LockCommandBar()
end)
CommandCount = CommandCount + 1
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'outlineplayer '),1,14) then
        ...
        if TracedTarget then
            ...
            AddNotification('Lily🗡️', TracedTarget.Name..' has been outlined',5)
        else
            AddNotification('Lily🗡️', 'Player was not found or there was a typo, further issues contact Coryu @killserver')
        end
    end
    LockCommandBar()
end)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'unoutlineplayer '),1,16) then
        ...
        if UntracedTarget then
            ...
            AddNotification('Lily🗡️', UntracedTarget.Name..' has been unoutlined',5)
        else
            AddNotification('Lily🗡️', 'Player was not found or there was a typo, further issues contact Coryu @killserver')
        end
    end
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'esp '),1,4) then
        ...
        if EspTarget then
            ...
            AddNotification('Lily🗡️', EspTarget.Name.." has been esp'd",5)
        else
            AddNotification('Lily🗡️', 'Player was not found or there was a typo, further issues contact Coryu @killserver')
        end
    end
...
UserCommand.FocusLost:Connect(function()
    if string.lower(string.sub(UserCommand.Text == 'gravity '),1,8) then
        ...
        if Work and Work:FindFirstChild'Gravity' then
            ...
            AddNotification('Lily🗡️', 'Gravity has been set to '..tonumber(GravitionalPull),5)
        end
    end
    LockCommandBar()
end)
...
UserCommand.FocusLost:Connect(function()
    if string.lower(UserCommand.Text == 'defaultgravity') then
        if Work and Work:FindFirstChild'Gravity' then
            Work.Gravity = 196.2
            AddNotification('Lily🗡️', 'Gravity has been set to 196.2',5)
        end
    end
    LockCommandBar()
end)
